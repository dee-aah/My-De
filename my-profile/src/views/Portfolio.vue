    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center mb-16">
        ...
        <p class="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          Berikut adalah beberapa proyek pilihan yang telah saya kerjakan, mulai dari pengembangan web hingga analisis
          data.
        </p>
      </div>
      <div class="flex flex-wrap justify-center gap-4 mb-12">
        <button v-for="category in categories" :key="category" @click="activeCategory = category"
          class="px-6 py-2 rounded-full text-sm font-medium transition-all duration-300 border" :class="[
            ...
            <div class="relative overflow-hidden aspect-video">
              ...
              <div
                ...
                <a :href="project.demoLink"
                  class="p-3 bg-white rounded-full text-gray-900 hover:text-blue-600 transition-colors"
                  title="Live Demo">
            ...
            <div class="p-6 flex flex-col flex-grow">
              ...
              <div class="flex items-center gap-4 pt-4 border-t border-gray-100 dark:border-gray-700 mt-auto">
                <a :href="project.repoLink"
                  class="flex items-center text-sm font-semibold text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                ...
                <a :href="project.demoLink"
                  class="flex items-center text-sm font-semibold text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors ml-auto">
                  Live Demo &rarr;
                </a>
              </div>
            </div>
